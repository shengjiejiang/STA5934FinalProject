...
saveRDS(betaWM1, "betaWM_null_S2_0.1.rds")
saveRDS(betaWM2, "betaWM_null_S2_0.2.rds")
saveRDS(betaWM3, "betaWM_null_S2_0.3.rds")
saveRDS(betaWM4, "betaWM_positive_S2_0.1.rds")
saveRDS(betaWM5, "betaWM_positive_S2_0.2.rds")
saveRDS(betaWM6, "betaWM_positive_S2_0.3.rds")
 print(mean(betaWM1))
 print(mean(betaWM2))
 print(mean(betaWM3))
 print(mean(betaWM4))
...
saveRDS(sebetaWM1, "sebetaWM_null_S2_0.1.rds")
saveRDS(sebetaWM2, "sebetaWM_null_S2_0.2.rds")
saveRDS(sebetaWM3, "sebetaWM_null_S2_0.3.rds")
saveRDS(sebetaWM4, "sebetaWM_positive_S2_0.1.rds")
saveRDS(sebetaWM5, "sebetaWM_positive_S2_0.2.rds")
saveRDS(sebetaWM6, "sebetaWM_positive_S2_0.3.rds")
...
saveRDS(betaPWM1, "betaPWM_null_S2_0.1.rds")
saveRDS(betaPWM2, "betaPWM_null_S2_0.2.rds")
saveRDS(betaPWM3, "betaPWM_null_S2_0.3.rds")
saveRDS(betaPWM4, "betaPWM_positive_S2_0.1.rds")
saveRDS(betaPWM5, "betaPWM_positive_S2_0.2.rds")
saveRDS(betaPWM6, "betaPWM_positive_S2_0.3.rds")
 print(mean(betaPWM1))
 print(mean(betaPWM2))
 print(mean(betaPWM3))
 print(mean(betaPWM4))
...
saveRDS(sebetaPWM1, "sebetaPWM_null_S2_0.1.rds")
saveRDS(sebetaPWM2, "sebetaPWM_null_S2_0.2.rds")
saveRDS(sebetaPWM3, "sebetaPWM_null_S2_0.3.rds")
saveRDS(sebetaPWM4, "sebetaPWM_positive_S2_0.1.rds")
saveRDS(sebetaPWM5, "sebetaPWM_positive_S2_0.2.rds")
saveRDS(sebetaPWM6, "sebetaPWM_positive_S2_0.3.rds")
...
saveRDS(betaIVW1, "betaIVW_null_S2_0.1.rds")
saveRDS(betaIVW2, "betaIVW_null_S2_0.2.rds")
saveRDS(betaIVW3, "betaIVW_null_S2_0.3.rds")
saveRDS(betaIVW4, "betaIVW_positive_S2_0.1.rds")
saveRDS(betaIVW5, "betaIVW_positive_S2_0.2.rds")
saveRDS(betaIVW6, "betaIVW_positive_S2_0.3.rds")
print(mean(betaIVW1))
print(mean(betaIVW2))
print(mean(betaIVW3))
print(mean(betaIVW4))
...
saveRDS(sebetaIVW1, "sebetaIVW_null_S2_0.1.rds")
saveRDS(sebetaIVW2, "sebetaIVW_null_S2_0.2.rds") 
saveRDS(sebetaIVW3, "sebetaIVW_null_S2_0.3.rds") 
saveRDS(sebetaIVW4, "sebetaIVW_positive_S2_0.1.rds") 
saveRDS(sebetaIVW5, "sebetaIVW_positive_S2_0.2.rds") 
saveRDS(sebetaIVW6, "sebetaIVW_positive_S2_0.3.rds") 
...
saveRDS(betaEGGER1, "betaEGGER_null_S2_0.1.rds")
saveRDS(betaEGGER2, "betaEGGER_null_S2_0.2.rds")
saveRDS(betaEGGER3, "betaEGGER_null_S2_0.3.rds")
saveRDS(betaEGGER4, "betaEGGER_positive_S2_0.1.rds")
saveRDS(betaEGGER5, "betaEGGER_positive_S2_0.2.rds")
saveRDS(betaEGGER6, "betaEGGER_positive_S2_0.3.rds")
...
saveRDS(sebetaEGGER1, "sebetaEGGER_null_S2_0.1.rds")
saveRDS(sebetaEGGER2, "sebetaEGGER_null_S2_0.2.rds")
saveRDS(sebetaEGGER3, "sebetaEGGER_null_S2_0.3.rds")
saveRDS(sebetaEGGER4, "sebetaEGGER_positive_S2_0.1.rds")
saveRDS(sebetaEGGER5, "sebetaEGGER_positive_S2_0.2.rds")
saveRDS(sebetaEGGER6, "sebetaEGGER_positive_S2_0.2.rds")
